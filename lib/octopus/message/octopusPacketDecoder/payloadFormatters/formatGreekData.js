...
function formatGreekData({
  ...
  // const formattedGreekData = (data, type = null, instrumentToken) => {
  //   if (data !== "" && data !== undefined && data !== null && data !== 0) {
  //     let formattedData = data / 1000000;
  //     console.log("DATASet", data, type, formattedData, instrumentToken);
  //     return stringifyNumberToIndianLocale(
  //       formattedData,
  //       type === "gamma" ? 4 : 2
  //     );
  //   } else return data;

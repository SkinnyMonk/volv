  ...
  return (
    <div className="w-full h-full flex flex-col">
      ...
      <div className="px-3 py-2 border-b border-white border-opacity-10">
        <p className="text-white text-xs font-semibold">TCS Options Chain</p>
        ...
        <div className="min-w-full text-xs">
          ...
          {optionChain.map((row) => (
            ...
            >
              ...
              <div className="w-20 shrink-0 text-center py-1.5 px-1 text-white font-bold border-l border-r border-white border-opacity-10 bg-slate-900 bg-opacity-50 text-xs">{formatINR(row.strike)}</div>
